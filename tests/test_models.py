...
def test_deprecated_properties():
    ...
    with pytest.warns(DeprecationWarning, match="Attribute 'model.old_origin' has been deprecated.  Use 'model.meta.origin' instead."):
    ...
    model.data = data
    with pytest.warns(DeprecationWarning, match="Attribute 'model.meta.old_data' has been deprecated.  Use 'model.data' instead."):
    ...
    with pytest.warns(DeprecationWarning, match="Attribute 'model.meta.array_property.baz' has been deprecated.  Use 'model.meta.array_property.bam' instead."):
